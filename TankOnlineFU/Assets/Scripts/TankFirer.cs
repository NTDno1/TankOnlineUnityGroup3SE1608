...
namespace DefaultNamespace
{
    public class TankFirer : MonoBehaviour
    {
        ...
        public void Fire(Bullet b, Tank tank)
        {
            ...
            if (b.bulletLv == 1 || tank.Name == "Enemy")
            {
                bullet = Instantiate(bulletPrefab, b.InitialPosition, Quaternion.identity);

            }
            else
            {
                bullet = Instantiate(bulletPrefablv2, b.InitialPosition, Quaternion.identity);
            }
